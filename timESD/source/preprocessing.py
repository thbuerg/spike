...
df1 = pd.read_csv("data/17-2-1 HS 2020-Q1.csv", sep=';', decimal=',', header=7)
df1.dropna(how='all', inplace=True)
df2 = pd.read_csv("data/17-2-1 HS 2020-Q2.csv", sep=';', decimal=',', header=7)
df2.dropna(how='all', inplace=True)
df3 = pd.read_csv("data/17-2-1 HS 2020-Q3.csv", sep=';', decimal=',', header=7)
df3.dropna(how='all', inplace=True)
df4 = pd.read_csv("data/17-2-1 HS 2020-Q4.csv", sep=';', decimal=',', header=7)
...
# import weather data
temp = pd.read_csv("data/produkt_zehn_min_tu_20191005_20210406_01270.txt", sep=';')
...
wind = pd.read_csv("data/produkt_zehn_min_ff_20191005_20210406_01270.txt", sep=';')
...
sun = pd.read_csv("data/produkt_zehn_min_sd_20191005_20210406_01270.txt", sep=';')
